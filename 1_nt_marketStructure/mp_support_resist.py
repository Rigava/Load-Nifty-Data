...
if __name__ == '__main__':
    ...
    # Add SMA trace
    fig.add_trace(go.Scatter(x=long_trades.index, y=long_trades["entry_price"], mode="markers",name="LongEntry", marker=dict(color="Green", size=8, symbol="triangle-up")))
    # fig.add_trace(go.Scatter(x=long_trades.exit_time, y=long_trades["exit_price"], mode="markers",name="LongExit", marker=dict(color="Red", size=8, symbol="circle")))
    fig.add_trace(go.Scatter(x=short_trades.index, y=short_trades["entry_price"], mode="markers",name="ShortEntry", marker=dict(color="black", size=8, symbol="triangle-down")))
    # fig.add_trace(go.Scatter(x=short_trades.exit_time, y=short_trades["exit_price"], mode="markers",name="ShortExit", marker=dict(color="grey", size=8, symbol="circle")))
    fig.write_html("mp_supp_res_long.html",auto_open=True)